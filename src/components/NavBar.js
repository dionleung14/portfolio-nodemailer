...
export default function Navbar() {
  ...
  return (
    <div>
      <div className="flex justify-around border-solid border-2 border-black w-full lg:pt-4 lg:pb-4 fixed top-0 mb-10 bg-dclnavy-300 z-40 text-dclbeige-100">
        <AnchorLink
          href="#top"
        ...
        <AnchorLink
          href="#meet-me"
          className="hidden lg:inline-block self-center border border-transparent hover:border-dclbeige-300 px-2 rounded text-lg"
        >
          meet me
        </AnchorLink>
        <AnchorLink
